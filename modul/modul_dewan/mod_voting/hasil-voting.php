                                    ...
                                    <div>
                                        ...
                                        <table class="table datatable">
                                            ...
                                            <?php 
                                                ...
                                                if($r['status'] == 0){
                                                    $status = '<span class="label label-warning label-form">Menunggu Jawaban Penelaah</span>';
                                                    ...
                                                    $status = '<span class="label label-info label-form">Terkirim</span>';
                                                    $button_tanyakan ='<button type="submit" class="pull-right btn btn-success">Kirim</button>';
                                                }else{
                                            ...
                                            <?php $no++; } ?>
                                            <?php 
                                                if(array_sum($total_nn) == 2){
                                                    $button_start = '<div class="panel-footer">                                                                        
                                                                        <button class="btn btn-primary pull-right">MULAI START REVIEW<span class="fa fa-play fa-right"></span></button>
                                                                    </div>';
                                                }elseif(array_sum($total_nn) == 1 && $total == 4){
                                                    $button_start = '<div class="panel-footer">                                                                        
                                                                        <button class="btn btn-primary pull-right">MULAI START REVIEW<span class="fa fa-play fa-right"></span></button>
                                                                    </div>';
                                                }elseif(array_sum($total_nn) == 0 && $total == 4){
                                                    $button_start = '';
                                                }else{
                                                    $button_start = '';
                                                }
