                               ...
                               <div class="panel panel-default">
                                ...
                                <?php
                                                ...
                                                if($r['status_kirim'] == 1){
                                                    ...
                                                    $message = 'Proses Penentuan Reviewer';
                                                ...
                                                $re="<span class='label label-warning'>Proses Review</span>";
                                                }
                                                else if ($r['status']=='diterima'){
                                ...
                                <div class="panel-body scroll" style="height: 230px;">                               
                                    ...
                                    <span class="text-muted"> <i class="fa fa-clock-o"></i><?php echo $tgl1; ?> <?php echo $re ?></span>
                                    <p>
                                  <?php echo $r['abstrak'] ?>
                                   </p>
                                    <?php } ?>    
