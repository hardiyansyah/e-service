				...
				$jmlrev=mysql_num_rows(mysql_query("select * from review where id_naskah='$rn[id_naskah]'"));
				$id_rev= mysql_query("SELECT * FROM review WHERE id_naskah='$_GET[id]' AND status='$jmlrev' ");
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        ...
                        <div class="panel-heading">
                            ...
                            <form method="POST" action="modul/mod_telaah/aksi_telaah.php" enctype="multipart/form-data" class="form-horizontal" >
                            <input type="hidden" name="id_reviewer" value=<?php echo $r['id_users']?>>
		   					<input type="hidden" name="id" value=<?php echo $idr['id_review']?>>  
                                ...
                                <div class="panel panel-default tabs">                            
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li><a href="#tab-third" role="tab" data-toggle="tab">Telaah Ke</a></li>
                                    </ul>
