<!-- START BREADCRUMB -->
                <ul class="breadcrumb push-down-0">
                    <li><a href="#">Home</a></li>
                    <li class="active">Perbaikan Naskah</li>
                </ul>
                <!-- END BREADCRUMB -->                                                
                ...
                <div class="content-frame">     
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-edit"></span> Perbaikan Naskah</h2>
                        </div>                                                
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">Upload Perbaikan Naskah</h3>
                                      <?php
                            $tampilnaskah= mysql_query("SELECT * FROM naskah WHERE id_naskah ='$_GET[id]'");
                            $tn=mysql_fetch_array($tampilnaskah);
                            $tampiluser= mysql_query("SELECT * FROM users WHERE id_users='$tn[id_users]'");
                            $tu=mysql_fetch_array($tampiluser);
                            $jmlrev=mysql_num_rows(mysql_query("SELECT * FROM revisi WHERE id_naskah='$tn[id_naskah]' AND id_reviewer = '$_GET[ref]' "))
                            ?>
                    <form method="POST" action="modul/modul_penulis/mod_naskah/aksi_naskah.php" enctype="multipart/form-data">        
                    <input type="hidden" name="id" value="<?php echo $tn['id_naskah']?>">
                    <input type="hidden" name="id1" value="<?php echo $_GET['ref']?>">
                    <input type="hidden" name="idusers" value="<?php echo $tu['id_users']?>">
                    <input type="hidden" name="isi" value="Silahkan Klik pesan ini untuk melihat hasil perbaikan naskah dengan judul <?php echo $tn['judul']?>">                              
