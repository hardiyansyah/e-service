                ...
                $r=mysql_fetch_array($tampil);                
                    $review= mysql_query("SELECT * FROM review WHERE id_review='$_GET[review]' AND id_reviewer='$_SESSION[id_user]'");
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form method="POST" action="modul/modul_reviewer/mod_telaah/aksi_telaah2.php" enctype="multipart/form-data" class="form-horizontal" >
                            ...
                            <input type="hidden" name="id_naskah" value="<?php echo $_GET['id']?>"> 
                             <input type="hidden" name="status_tgl" value="<?php echo $nas['status_tgl']?>">
                                ...
                                <div class="panel panel-default tabs">                            
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li><a href="#tab-third" role="tab" data-toggle="tab">Rekomendasi Hasil Review</a></li>
                                    </ul>
                                    <div class="panel-body tab-content">
                                        <div class="tab-pane active" id="tab-first">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" value="<?php echo $nas['intansi']?>">                                                    
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Satuan Kerja</label>
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" value="<?php echo $nas['satker']?>">                                                    
                                                </div>
                                            </div>
                                            ...
                                            <?php 
                                            $jmlrev=mysql_num_rows(mysql_query("SELECT * FROM review WHERE id_naskah='$nas[id_naskah]' AND id_reviewer = '$_SESSION[id_user]' "))
                                            ?>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane" id="tab-second">
                                           ...
                                           <div class="form-group">                                        
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                <textarea name="gaya" class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="tab-pane" id="tab-third">
                                         ...
                                         <div class="form-group">                                        
                                            ...
                                            <input type="hidden" name="id_reviewer" value="<?=$r['id_users']?>">
