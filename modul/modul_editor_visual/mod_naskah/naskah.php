...
<!-- START RESPONSIVE TABLES -->
                ...
                <div class="page-content-wrap">                
                    ...
                    <h3><span class="fa fa-book"></span> Data Naskah</h3>
                        ...
                        if($r['status_kirim'] == 1 && $r['status'] =='masuk') {
                            $message = 'Belum Dikirim Ke Dewan';
                            $css = 'label label-info';
                        }else if($r['status_kirim'] == 3 && $r['status'] =='sunting'){
                            $message = 'Proses Penyuntingan';
                            $css = 'label label-info';
                        }else{
						...
						$re="<span class='".$css."'>Di Terima (Lolos Penilaian)</span>";
						}
                        ...
                        $stat=$_GET['id'];
                            ...
                            ?>                      
                                                ...
                                                <tr id="trow_1">
                                                    ...
                                                    <td><strong><a href="media.php?hal=editor_visual-<?php echo $link?>-naskah&id=<?php echo $r['id_naskah']?>"><?php echo $r['judul'] ?></a></strong></td>
