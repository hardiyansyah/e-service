                ...
                <div class="content-frame">     
                    ...
                    <!-- END CONTENT FRAME TOP -->
                     <h3> Identitas Naskah </h3>
                        ...
                        <br><br>
                        <?php if ($r2['status']=='diterima'){?>
                            <form action="modul/modul_editor/mod_naskah/kirim_visual.php" method="post">
                                <input type="hidden" name="id_naskah" value="<?php echo $r2['id_naskah']?>"/>
                                <input type="hidden" name="idUser" value="<?php echo $_SESSION['id_user']?>"/>
                                <input type="hidden" name="namaEditor" value="<?php echo $_SESSION['namalengkap']?>"/>
                                <input type="hidden" name="idPenulis" value="<?php echo $r3['id_users']?>"/>
                                <input type="hidden" name="tgl" value="<?php echo $r2['status_tgl']?>"/>
                                <button type="submit" class="btn btn-primary" ><span class="fa fa-sign-in"></span> Kirim Ke Editor Visual</button></a>
                            </form>
                        <?php } ?>
                    </div>
