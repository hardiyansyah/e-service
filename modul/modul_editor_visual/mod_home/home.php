...
$jum4= mysql_num_rows(mysql_query("SELECT * FROM naskah WHERE status='sunting'"));
                            ...
                            <div class="widget widget-default widget-carousel">
                                <div class="owl-carousel" id="owl-example">
                                    ...
                                    <div>                                    
                                        ...
                                        <div class="widget-subtitle">Keseluruhan</div>
                                        <div class="widget-int"><?php echo $jum3;?></div>
                                    </div>
                                    <div>                                    
                                        <div class="widget-title">Total Naskah</div>
                                        <div class="widget-subtitle">Proses Penyuntingan</div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon" onclick="location.href='pages-messages.html';">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo "$jum4"; ?></div>
                                    <div class="widget-title">Naskah Proses Penyuntingan</div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               <div class="panel panel-default">
                                ...
                                <?php
                                $tp=mysql_query("SELECT * FROM naskah WHERE status ='sunting' ORDER BY id_naskah DESC ");
