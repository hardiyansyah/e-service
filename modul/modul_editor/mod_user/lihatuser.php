...
$edi = mysql_query("SELECT * FROM users WHERE id_users='$_GET[id]'");
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="modul/modul_editor/mod_user/edit_user.php" enctype="multipart/form-data">
