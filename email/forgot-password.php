                            ...
                            <td>
                                <table align="left" width="180" border="0">
                                    <tbody>
                                        <tr align="left">
                                            <td>
                                                <a href="http://e-service.lipipress.lipi.go.id/" target="_blank"><img src="http://e-service.lipipress.lipi.go.id/logo-lipi.png" alt="LIPI Press" height="80px" border="0">
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Anda Baru saja mereset password, berikut data password baru Anda :
                    </p>
                    
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                            <td colspan="5" align="right" valign="top" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3;font-weight:bold;text-align:left"><div align="left">DATA PASSWORD</div></td>
                        </tr>
                        <tr>
                    ...
                    Jika Anda tidak merasa mereset password, segera hubungi Admin LIPI Press Telp. (+62) 21 3140228 .
                    </p>
