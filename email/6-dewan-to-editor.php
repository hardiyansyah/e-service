                            ...
                            <td>
                                <table align="left" width="180" border="0">
                                    <tbody>
                                        <tr align="left">
                                            <td>
                                                <a href="http://funtravel.myfunbizz.co.id/" target="_blank"><img src="logo.png" alt="header-logo" height="80px" border="0">
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Berdasarkan hasil voting dari Dewan Editor, Dewan menentukan <strong>"JUDUL NASKAH"</strong>  di Review oleh :
                    </p>
                    <br>
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        ...
                        <tr>
                            <td width="50%" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;background:#dceff5;font-weight:bold;text-align:center">
                                <div align="left">Reviewer 2</div>
                            </td>
                            <td width="50%" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;background:#dceff5;font-weight:bold;text-align:center">
                                <div align="left">: Hardiansyah</div>
                            </td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>Kepo Ich</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>Menunggu Konfirmasi Reviewer</strong></div>
                            </td>
                        </tr> -->                       
                        </tbody>
                    </table>
                    ...
                    <!-- <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>Menunggu Nama Reviewer</strong></div>
                            </td>
                        </tr>                        
                        </tbody>
                    </table> -->
					<!-- <p align="center" style="margin:20px 0pt 0pt;line-height:150%"><em>Mohon untuk segera menentukan 2 Nama Reviewer untuk naskah ini</em></p> -->
                    ...
                    <p>Terima Kasih</p>
                    <p><strong>Nama Dewan Editor</strong>
                      </p>
                </td>
            </tr>
            <tr>
