                            ...
                            <td>
                                <table align="left" width="180" border="0">
                                    <tbody>
                                        <tr align="left">
                                            <td>
                                                <a href="http://lipi.wisasi.com/" target="_blank"><img src="http://lipi.wisasi.com/logo-lipi.png" alt="header-logo" height="80px" border="0">
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Berikut data naskah yang telah Lolos Verifikasi
                    </p>
                    <br>
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                            <td colspan="5" align="right" valign="top" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3;font-weight:bold;text-align:left"><div align="left">DATA PENULIS</strong></div></td>
                        </tr>
                        <tr>
                            ...
                            <td width="50%" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;background:#dceff5;font-weight:bold;text-align:center">
                                <div align="left">'.$namaPenulis.'</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>'.$nipPenulis.'</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>'.$jabatanPenulis.'</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                    ...
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>'.$intansi.'</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>'.$status.' (Menunggu Voting)</strong></div>
                            </td>
                        </tr>                        
                        </tbody>
                    </table>
					<p align="center" style="margin:20px 0pt 0pt;line-height:150%"><em>Mohon untuk segera menentukan dan melakukan voting Nama Penelaah untuk naskah ini</em></p>
                    ...
                    <p style="margin:20px 0pt 0pt;line-height:150%;text-align:justify;">Klik <a href="'.$linknaskah.'" target="_blank">Disini</a> Untuk Melihat Naskah Detail Naskah</p>
                    <p>Terima Kasih</p>
