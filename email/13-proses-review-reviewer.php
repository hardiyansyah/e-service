            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <!-- <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                            <td colspan="5" align="right" valign="top" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3;font-weight:bold;text-align:left"><div align="left">DATA TELAAH</strong></div></td>
                        </tr>
                        <tr>
                    ...
                    <!-- <p align="center" style="margin:20px 0pt 0pt;line-height:150%"><em>
                        Menyatakan <strong>TIDAK SANGGUP</strong> untuk menelaah naskah sebagai berikut :
                    </em></p> -->
                    ...
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: Proses Telaah</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Telaah Ke</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: '.$tgl1.'</strong></div>
                            </td>
                        </tr> 
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Hasil Usulan</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                        ...
                        <!--
                         <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: '.$komentar.'</strong></div>
                            </td>
                        </tr> -->                             
                        </tbody>
                    </table>
                    ...
                    Telah selesai ditelaah klik <a href="'.$site.'media.php?hal=editor-review">DISINI</a> untuk melihat detail naskah dan hasil telaah.
                    </p>
