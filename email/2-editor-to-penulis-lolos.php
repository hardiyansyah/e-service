                        ...
                        <tbody><tr>
                            <td>
                                ...
                                <table align="right" width="500" style="margin-top:50px;border-collapse:collapse" border="0">
                                    <tbody>
                                        <tr align="right">
                                            <td><h1 style="font-size:18px;color:#4c4848;font-weight:bold"><span style="color:rgb(76,72,72);font-weight:bold">Proses Verifikasi Naskah</span></h1></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Selamat, Naskah Anda telah <strong>Lolos Verifikasi Dan Mulai Proses Telaah</strong>, berikut data naskah tersebut kami informasikan :
                    </p>
