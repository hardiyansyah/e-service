        ...
        <table style="border-collapse:collapse;border-spacing:0px" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tbody><tr>
                            <td>
                                ...
                                <table align="right" width="500" style="margin-top:50px;border-collapse:collapse" border="0">
                                    <tbody>
                                        <tr align="right">
                                            <td><h1 style="font-size:18px;color:#4c4848;font-weight:bold"><span style="color:rgb(76,72,72);font-weight:bold">Permohonan Naskah Baru</span></h1></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p>Dear <strong>'.$namaEditor.' (Dewan Editor) </strong>,</p>
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Berikut Detail Permohonan Naskah dari Penulis :
                    </p>
                    <br>
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                            <td colspan="5" align="right" valign="top" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3;font-weight:bold;text-align:left"><div align="left">DETAIL PENULIS</strong></div></td>
                        </tr>
                        <tr>
                    ...
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                       ...
                       <!-- <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: '.$abstrak.'</strong></div>
                            </td>
                        </tr> -->
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: Masuk</strong></div>
                            </td>
                        </tr>                        
                        </tbody>
                    </table>
                    <p>Terima Kasih,</p>
                    <p><strong>Penulis ('.$namaPenulis.')</strong>
                    </p>
                </td>
            </tr>
            <tr>
