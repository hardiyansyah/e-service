            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Selamat, naskah anda telah memasuki proses Telaah Ke - '.$status.', berikut detail naskah anda :
                    </p>
                    <!-- <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                            <td colspan="5" align="right" valign="top" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3;font-weight:bold;text-align:left"><div align="left">DATA PENELAAH</strong></div></td>
                        </tr>
                        <tr>
                    ...
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        ...
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Status Telaah Naskah</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: Proses Telaah ke '.$status.'</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Hasil Penilaian</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: '.$nilai.'</strong></div>
                            </td>
                        </tr>
                         <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Di Telaah Oleh</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: Telaah '.$jabatan.'</strong></div>
                            </td>
                        </tr>
                                               
                        </tbody>
                    </table>
					<p align="center" style="margin:20px 0pt 0pt;line-height:150%"><em>Klik <strong><a href="'.$site.'media.php?hal=penulis-monitoring&id='.$id_naskah.'">DISINI</a></strong> untuk melihat detail naskah anda.</em></p>
                    <!-- <p style="margin:20px 0pt 0pt;line-height:150%;text-align:justify;">Terima kasih telah membeli tiket di FunTravel! Semoga anda merasakan kepuasan memesan tiket disini.</p>
