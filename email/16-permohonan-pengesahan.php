            ...
            <tr>
                <td style="background-color:rgb(255,255,255);padding:0px 15px 0px 15px">
                    ...
                    <p style="margin-bottom:10px;line-height:150%;text-align:justify">
                        Naskah dengan detail sebagai berikut :
                    </p>
                    <!-- <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                            <td colspan="5" align="right" valign="top" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3;font-weight:bold;text-align:left"><div align="left">DATA REVIEWER</strong></div></td>
                        </tr>
                        <tr>
                            ...
                            <td width="50%" style="font-size:12px;font-family:Arial,Helvetica,sans-serif;background:#dceff5;font-weight:bold;text-align:center">
                                <div align="left">: Benny Sofyan</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: Pangluhurna</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">NIP</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: 11223344556677</strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">No. Handphone</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: 081234567890</strong></div>
                            </td>
                        </tr>                      
                        </tbody>
                    </table> -->
                    <!-- <p align="center" style="margin:20px 0pt 0pt;line-height:150%"><em>
                        Menyatakan <strong>TIDAK SANGGUP</strong> untuk mereview naskah sebagai berikut :
                    </em></p> -->
                    <!-- <p align="right" style="margin-top:15px">Dikirim pada : 2015-07-24 17:12:08</p> -->
                    <!-- <br> -->
                    <table width="700" cellspacing="0" cellpadding="5" style="border:1px solid #dee2e3">
                        <tbody>
                        <tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                             ...
                             <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Usulan Penilaian</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong style="color:green">: '.$nilai.'</strong></div>
                            </td>
                        </tr>
                         <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Nama Penelaah</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: '.$namaReviewer.'</strong></div>
                            </td>
                        </tr>    
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Jabatan Penelaah</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong>: Telaah ke '.$jabatan.'</strong></div>
                            </td>
                        </tr>    
                        <tr>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left">Status Naskah</div>
                            </td>
                            <td valign="top" style="font-size:11px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #dee2e3">
                                <div align="left"><strong style="color:green">: Menunggu Pengesahan Dewan Editor</strong></div>
                            </td>
                        </tr>                       
                        </tbody>
                    </table>
					<!-- <p align="center" style="margin:20px 0pt 0pt;line-height:150%"><em>Klik <strong><a href="#">DISINI</a></strong> untuk melihat detail naskah anda.</em></p> -->
                    <p style="margin:20px 0pt 0pt;line-height:150%;text-align:justify;">
                    Silahkan klik <a href="'.$site.'media.php?hal=dewan-penilaian">DISINI</a> untuk melakukan proses pengesahan naskah.
                    </p>
